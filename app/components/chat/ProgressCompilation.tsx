  ...
  return (
    <AnimatePresence>
      ...
      >
        <div
          className={classNames(
            'bg-qbuildr-elements-item-backgroundAccent',
            'p-1 rounded-lg text-qbuildr-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-qbuildr-elements-item-backgroundAccent hover:bg-qbuildr-elements-artifacts-backgroundHover"
