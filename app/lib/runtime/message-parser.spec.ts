...
describe('StreamingMessageParser', () => {
  ...
  describe('no artifacts', () => {
    ...
    ])('should correctly parse chunks and strip out qbuildr artifacts (%#)', (input, expected) => {
  ...
  describe('invalid or incomplete artifacts', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      ['Foo bar <bol', 'Foo bar '],
      ['Foo bar <qbuildr', 'Foo bar '],
      ['Foo bar <qbuildra', 'Foo bar <qbuildra'],
      ['Foo bar <qbuildrA', 'Foo bar '],
      ['Foo bar <qbuildrArtifacs></qbuildrArtifact>', 'Foo bar <qbuildrArtifacs></qbuildrArtifact>'],
      ['Before <oltArtfiact>foo</qbuildrArtifact> After', 'Before <oltArtfiact>foo</qbuildrArtifact> After'],
      ['Before <qbuildrArtifactt>foo</qbuildrArtifact> After', 'Before <qbuildrArtifactt>foo</qbuildrArtifact> After'],
    ])('should correctly parse chunks and strip out qbuildr artifacts (%#)', (input, expected) => {
      runTest(input, expected);
    });
  });
  ...
  describe('valid artifacts without actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Some text before <qbuildrArtifact title="Some title" id="artifact_1">foo bar</qbuildrArtifact> Some more text',
        {
      ...
      [
        [
          'Some text before <qbuildrArti',
          'fact',
          ' title="Some title" id="artifact_1" type="bundled" >foo</qbuildrArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' ',
          '>',
          'foo</qbuildrArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' >fo',
          'o</qbuildrArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          'o',
          '<',
          '/qbuildrArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        'Before <qbuildrArtifact title="Some title" id="artifact_1">foo</qbuildrArtifact> After',
        {
          output: 'Before  After',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Before <qbuildrArtifact title="Some title" id="artifact_1"><qbuildrAction type="shell">npm install</qbuildrAction></qbuildrArtifact> After',
        {
          output: 'Before  After',
      ...
      [
        'Before <qbuildrArtifact title="Some title" id="artifact_1"><qbuildrAction type="shell">npm install</qbuildrAction><qbuildrAction type="file" filePath="index.js">some content</qbuildrAction></qbuildrArtifact> After',
        {
          output: 'Before  After',
